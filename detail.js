...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (data.image_url) {
        ...
        document.querySelector('.item-card').prepend(img);
    }
    ...
    badge.style = "padding:5px 10px; border-radius:20px; margin-left:10px; font-size:0.6em; color:white;";
    ...
    document.querySelector('.item-card').appendChild(thanksBtn);
    ...
    document.querySelector('.item-card').appendChild(soldBtn);

    // マップ
    document.getElementById('map-frame').src = `http://googleusercontent.com/maps.google.com/6{encodeURIComponent(data.store_name)}`;
